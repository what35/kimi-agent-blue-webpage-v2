export const SITE_DATA: SiteData = {
  profile: {
    ...
    hobbies: [
      ...
      {
        name: "研究 AI 新工具",
        detail: "喜欢把学到的东西做成小工具，解决工作中的实际问题。",
      },
      {
        name: "游戏爱好者",
        detail: "巫师3、艾尔登法环玩过，阶段性上头过三角洲、燕云十六声",
      },
      {
        name: "港乐爱好者",
        detail: "最喜欢的歌手是容祖儿（不唱挥着翅膀的女孩版）",
      },
      {
        name: "老吃家",
        detail: "命带天厨贵人",
  ...
  ideas: [
    {
      id: "idea-02",
      content: "研发费用审核软件",
      detail: "我真的受够了研发费用了，目前在筹谋做一个对sap导出数据审核的研发费用软件",
      category: "设计",
      color: "#FFCE5C",
      rotation: 2,
      date: "2026-05-28",
