...
export const SITE_DATA: SiteData = {
  profile: {
    ...
    skills: [
      ...
      { name: "vibe coding", level: 75, shape: "dot", color: "#4F8CFF", detail: "用轻松、直觉驱动的方式与 AI 协作，把想法快速变成可用的小工具。" },
    ],
    hobbies: [
      ...
      { name: "游戏爱好者", detail: "喜欢玩各种类型的游戏，从像素风独立游戏到 3A 大作都感兴趣。" },
      { name: "港乐爱好者", detail: "喜欢听粤语歌，从经典老歌到新生代作品都有涉猎。" },
      { name: "老吃家", detail: "热爱探索各地美食，喜欢找藏在巷子里的宝藏小店。" },
    ],
    timeline: [
      {
        year: "2025",
